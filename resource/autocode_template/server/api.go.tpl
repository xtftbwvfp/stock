...
import (
    ...
    "github.com/ykstudy/stock/model/{{.Package}}"
    "github.com/ykstudy/stock/model/common/request"
    {{.Package}}Req "github.com/ykstudy/stock/model/{{.Package}}/request"
    "github.com/ykstudy/stock/model/common/response"
    "github.com/ykstudy/stock/service"
