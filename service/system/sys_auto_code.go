...
import (
	...
	"errors"
	"fmt"
	ast2 "github.com/ykstudy/stock/utils/ast"
	"io"
	"mime/multipart"
	"os"
	"path/filepath"
	...
	"github.com/ykstudy/stock/resource/autocode_template/subcontract"
	"go.uber.org/zap"

	"github.com/ykstudy/stock/global"
	"github.com/ykstudy/stock/model/system"
	"github.com/ykstudy/stock/utils"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "github.com/ykstudy/stock/%s/%s",
			packageNameF: "%s",
...
func skipMacSpecialDocument(info os.FileInfo, src, dest string) (bool, error) {
